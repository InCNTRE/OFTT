...
class TestCase:
    ...
    """This is a PERF008 test case from test cases template document.
       1000 flows, 7 parameters, 6 ports (flows evenly distributed).
    ...
    def run(self):
        ...
        for n in range(numberOfFlows):
            ...
            flow = "in_port=" + str(port) + ",dl_type=0x0800,dl_vlan=" + str(n) + ",dl_src=00:03:12:23:B0:55,dl_dst=56:34:23:12:32:43,nw_proto=" + str(proto) + ",nw_src=192.168.1.1,actions=output:1"
